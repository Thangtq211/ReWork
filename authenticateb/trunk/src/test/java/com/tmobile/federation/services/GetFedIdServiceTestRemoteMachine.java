...
public class GetFedIdServiceTestRemoteMachine {
    ...
    public void clientQueryAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?iamUserId=U-82bf6ba6-88f5-4049-b86c-860dca0c9fb3&email=email@mobile.com&tenantId=xyz123";
    ...
    public void clientQueryMissingIAMUserIDAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?email=email@mobile.com&tenantId=xyz123";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
    ...
    public void clientQueryMissingIAMUserIDAndTenantIDAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?email=email@mobile.com";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
    ...
    public void clientQueryMissingEmailAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?iamUserId=U-82bf6ba6-88f5-4049-b86c-860dca0c9fb3&tenantId=xyz123";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
    ...
    public void clientQueryMissingTenantAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?iamUserId=U-82bf6ba6-88f5-4049-b86c-860dca0c9fb3&email=email@mobile.com";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
    ...
    public void clientQueryMissingEmailAndTenantAnExistedFederatedIDFromWebLogicThen200OK() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?iamUserId=U-82bf6ba6-88f5-4049-b86c-860dca0c9fb3";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
    ...
    public void clientQueryMissingAllFederatedIDFromWebLogicThen400BadRequest() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
        String responseBody = responseEntity.getBody();
        System.out.println("responseEntity UserProfiles from Server .... \n" + responseBody);
        assertThat(responseEntity.getStatusCode(), equalTo(HttpStatus.OK));
    ...
    public void clientQueryANonExistedFederatedIDFromWebLogicThen400BadRequest() {
        ...
        headers.add("transactionId", "123123");
        HttpEntity<String> entity = new HttpEntity<String>(headers);
        String queryFederatedID = "http://localhost:7001/authenticateb/provisioning/v1/fedId?iamUserId=U-82bf6ba6-88f5-4049-b86c-860dca0c9&email=email1@mobile.com&tenantId=xyz1231";
        ResponseEntity<String> responseEntity = restTemplate.exchange(queryFederatedID, HttpMethod.GET, entity, String.class);
        String responseBody = responseEntity.getBody();
        System.out.println("responseEntity UserProfiles from Server .... \n" + responseBody);
        assertThat(responseEntity.getStatusCode(), equalTo(HttpStatus.OK));
