...
public class IAMFederationProfileService extends IAMBaseFederationService {

	private static final Logger logger = Logger.getLogger(IAMFederationProfileService.class);
