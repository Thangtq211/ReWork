...
private static final Logger logger = Logger.getLogger(EnterpriseDAOImpl.class);
	...
	public EnterpriseResponse createEnterprise(Enterprise enterprise) {
		...
		try {
			if (enterprise.getFederationInfo()!=null) {
				if (enterprise.getFederationInfo().getAutoUserOnboardingEnabled()!=null && enterprise.getFederationInfo().getAutoUserOnboardingEnabled()) {
					auto_onboarding="Y";
				} else {
					auto_onboarding="N";
				}
