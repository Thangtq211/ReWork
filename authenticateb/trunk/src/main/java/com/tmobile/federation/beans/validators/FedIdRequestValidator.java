...
public class FedIdRequestValidator {
    ...
    public static String validateFedIdRequestBean(FedIdRequestBean fedIdRequestBean) {
        if (fedIdRequestBean.getEmail() == null || fedIdRequestBean
          .getEmail()
          .trim()
          .isEmpty()) {
            return "email";
          ...
          .getInstance()
          .isValid(fedIdRequestBean.getEmail())) {
            return "email";
        }
        if (fedIdRequestBean.getTenantId() == null || fedIdRequestBean
          .getTenantId()
          .trim()
          .isEmpty()) {
            return "tenantId";
        }
        if (fedIdRequestBean.getStatus() == null || fedIdRequestBean
          .getStatus()
          .trim()
          .isEmpty()) {
            return "status";
        }
        if (fedIdRequestBean.getRole() == null || fedIdRequestBean
          .getRole()
          .trim()
          .isEmpty()) {
            return "role";
    ...
    public static String validateFedIdRequest(String email, String iamUserId, String tenantId) {
        if (iamUserId != null) if (iamUserId.isEmpty() == false) return null;
        if (email != null) if (email.isEmpty() == false) return null;
